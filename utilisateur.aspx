<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="utilisateur.aspx.cs" Inherits="creation.WebForm3" %>
    ...
    <ul class="nav navbar-nav">
     ...
     <form id="form1" runat="server">
         ...
         <div style="height: 605px; background-color: #FFFFFF;">
            <table>
            <tr>
            <td> <asp:Label ID="Label1" runat="server" Text="idUser"></asp:Label></td>
           ...
           <td> <asp:Label ID="Label5" runat="server" Text="MotDePasse"></asp:Label></td>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idUser" DataSourceID="SqlDataSource1" Width="672px" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
